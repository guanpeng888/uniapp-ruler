<template>
	<canvas 
	:class="['ruler-canvas', {'ruler-mantle': isShowMantle}]"
		...
		methods: {
			...
			drawHorizontalRulerDial(ctx) {
				...
				for (let i = startX; i < totalScaleCountPerView; i++) {
					let posX = (i - startX) * this.stepInterval + 10; //后面的10像素为左边距，距canvas左边10像素开始画
